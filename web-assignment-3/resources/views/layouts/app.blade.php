...
<li class="navigation__item">
    ...
    <a href="{{ route('home') }}" class="footer__navigation__link">Home</a>
</li>
<li class="footer__navigation__item">
    <a href="{{ route('about') }}" class="footer__navigation__link">About Us</a>
</li>
<li class="footer__navigation__item">
    <a href="{{ route('services') }}" class="footer__navigation__link">Our Services</a>
</li>
<li class="footer__navigation__item">
    <a href="{{ route('contact') }}" class="footer__navigation__link">Contact Us</a>
</li>
